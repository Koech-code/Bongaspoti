        ...
        <form>
          ...
          <div class="relative">
            <select
              ...
              className="focus:border-blue-600 block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline"
            >
              <option></option>
              <option>Kenya</option>
              <option>USA</option>
            ...
            <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
              <svg
                ...
                viewBox="0 0 20 20"
              >
                <path d="M14.706 7.706a1 1 0 00-1.414-1.414l-2.829 2.829L9.293 6.293a1 1 0 00-1.414 1.414l2.828 2.828a1 1 0 001.414 0l2.828-2.828z" />
              </svg>
            </div>
          </div>
          <label>Home Country</label>
