...
const HomePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("http://95.179.222.128/api/feed/create/", formData, {
        headers: {
        ...
        <form onSubmit={handleSubmit}>
          <div className="bg-white shadow-lg rounded-lg p-6 m-4">
            ...
            <div className="flex justify-between">
              ...
              <button
                type="submit"
                className="p-2 text-sm bg-blue-600 hover:bg-white-700 text-white font-bold py-2 px-4 rounded"
              >
                Tweet
              </button>
            </div>
