  ...
  return (
    ...
    <div className="px-4 py-4">
      <div className="flex items-center">
        <img className="w-12 h-12 rounded-full mr-4 object-cover" src={profimage} alt="Profile Image" />
        <div>
      ...
      <p className="mt-4 text-gray-700 text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non risus. Suspendisse lectus tortor, dignissim sit amet, adipiscing nec, ultricies sed, dolor. </p>
    </div>
    ...
    <div className="list-wrapper">
      ...
      <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
        <div className="text-md lg:flex-grow ">
          ...
          <Link className="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-green-500 mr-6">Feeds</Link>
          <Link className="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-green-500 mr-6">Journals</Link>
          <Link className="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-green-500 mr-6">Academics</Link>
          <Link className="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-green-500 mr-6">Achievements</Link>
          {/* <Outlet /> */}
