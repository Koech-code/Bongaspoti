  ...
  <div className='container-sm mb-4 overflow-hidden'>
      ...
      <div className="flex flex-wrap -mx-4">
        <div className="w-1/3 ml-auto bg-[#F9FBFC] m-2 p-4 rounded-md">
          ...
          <div className='pr-2'>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#0FFF00" class="w-6 h-6">
            ...
            <p className='p-2 text-gray-300'>Please provide name, home country and date of birth</p>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#0FFF00" class="w-6 h-6">
            ...
            <div className="w-1/3 mr-auto">
              <p className='font-semibold text-gray-300'>Athletic Information</p>
            </div>
            <p className='p-2 text-gray-300'>Please provide name, home country and date of birth</p>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#0FFF00" class="w-6 h-6">
            ...
            <div className="w-1/3 mr-auto">
              <p className='font-semibold text-gray-300'>Establishing Contact</p>
            </div>
            <p className='p-2 text-gray-300'>Please provide name, home country and date of birth</p>
        ...
        <p className='font-semibold text-2xl p-4 ml-4'>Academic Information</p>
        <div className="mb-4">
        ...
        <div className="mb-4">
            <label htmlFor="certificate" className="block font-medium mb-2">
              Did you or will you receive a high school certificate after 12 or 13 years
            </label>
              <input
                type="text"
                id="certificate"
        ...
        <div className='flex justify-between'>
          ...
          <div className="mb-4 ml-2 self-end">
            <label className="block text-gray-700 font-bold mb-2" for="city">
              Have you repeated a grade level or had a break in your studies since Form 1?
            </label>
            <div className="relative">
              <select
                className="w-full border-gray-400 border-solid border-2 rounded-md px-3 py-2 focus:outline-none"
        ...
        <div className="mb-4 ml-2 self-end">
          ...
          <div className='flex justify-between mt-40'>
            <div class="self-start">
              <button className="flex items-center gap-1 bg-white hover:bg-white hover:text-green-600 text-green-500 font-medium py-2 px-4 rounded-md">
